...
public:
    RainfallRecorder(z3::context& context, std::ostream& output,
                     std::string run = {});
    ...
    std::string term(z3::expr const& expression,
                     std::string_view representation = "semantic-z3");

    void record(std::string_view kind, std::string_view operation,
